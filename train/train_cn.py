...
parser.add_argument('--model', default='yechen/bert-large-chinese', type=str, help='bert model')
...
# 连接每个数据集作为训练集
data = pd.concat([data_worse[:-1], data_better[:-1]], axis=0).reset_index(drop=True)
